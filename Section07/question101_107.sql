...
alter table emp03
	add constraint emp03_unique unique (empno);
...
insert into emp03 values (1001, '김주화', '사원', 30);
...
insert into emp03 values (1003, '이길동', '사원', 40, default);
insert into emp03 values (1003, '이길동', '사원', 40, 'USA');

-- 문제107			
-- 아래 데이터를 emp03에 삽입하고 조회를 하여 location이 서울로 나오는지
-- 직접 확인하시오.			
-- 1003, '신은비', '사원', 30	
insert into emp03 values (1003, '이길동', '사원', 30);
insert into emp03 values (1003, '이길동', '사원', 30, default);
